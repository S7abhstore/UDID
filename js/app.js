...
$('.readNoti').click(function(){
    ...
    $.ajax({
        type: "GET",
        url: $(this).attr('url') +'/'+ id + "/read",
        async: true
    });
    $(this).parent().removeClass('bg-info');
    $('.top-nav-icon-badge').text($('.top-nav-icon-badge').html()-1);
});

$('.read-all').click(function(){
    $.ajax({
        type: "GET",
        url: $(this).attr('url') + "/readAll",
        async: true
    });
    $('.readNoti').parent().removeClass('bg-info');
...
$('.clear-notifications').click(function(){
    $.ajax({
        type: "GET",
        url: $(this).attr('url') + "/deleteAll",
        async: true
    });
    $('.readNoti').parent().remove();
    $('.top-nav-icon-badge').text('0');
});
